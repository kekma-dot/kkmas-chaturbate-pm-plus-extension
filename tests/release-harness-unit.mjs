...
const versionContractPath = path.join(projectRoot, "tests", "version-051-contract.mjs");
...
assert.equal(fs.existsSync(versionContractPath), true, "0.5.1 contract test must exist");
assert(runnerSource.includes("tests/version-051-contract.mjs"), "release test runner must include the 0.5.1 contract test");
